...
function generateMap() {
  ...
  var address = apartment.address; // Istanza dell' oggetto mappa
  ...
  map.addControl(new tt.NavigationControl()); // Creazione del marker
  ...
  var myChart = new Chart(ctx, {
    ...
    data: {
      ...
      datasets: [{
        label: 'N° di Visite',
        data: arr1,
        backgroundColor: ['rgba(233, 74, 71, 0.2)'],
        borderColor: ['rgba(233, 74, 71, 1)'],
        borderWidth: 1
      }, {
        label: 'N° di Messaggi',
        data: arr2,
        backgroundColor: ['rgba(99, 151, 208, 0.2)'],
        borderColor: ['rgba(99, 151, 208, 1)'],
        borderWidth: 1
      }]
    },
    options: {
